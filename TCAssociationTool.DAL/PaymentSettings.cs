...
namespace TCAssociationTool.DAL
{
    public class PaymentSettings
    {
        ...
        public DataTable GetPaymentSettings(ref int Status)
        {
            DataTable dt = null;
            try
            {
                ...
                dt = _dbAccess.GetDataTable("GetPaymentSettingsDetails", ref _sqlP);
        ...
        public Int64 UpdatePaymentDetails(TCAssociationTool.Entities.PaymentSettings objPaymentSettings)
        {
            Int64 _status = 0;
            try
            {
